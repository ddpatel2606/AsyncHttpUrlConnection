...
public class AsyncSimpleMultipart {
	...
	public boolean isSetLast = false;
	public boolean isSetFirst = false;

	public AsyncSimpleMultipart() {
	...
	public void addPart(final String key, final String fileName, final InputStream fin, final boolean isLast) throws IOException {
		addPart(key, fileName, fin, "application/octet-stream", isLast);
	}

	public void addPart(final String key, final String fileName, final InputStream fin, String type, final boolean isLast) throws IOException {
		writeFirstBoundaryIfNeeds();
		try {
	...
	public void addPart(final String key, final File value, final boolean isLast) throws IOException {
