...
public class AsyncHttpHeaders implements Serializable {

	public static final long serialVersionUID = -4953781862024963243L;

	/* Stores the request headers */
	public final ConcurrentMap<String, List<String>> headers = new ConcurrentHashMap<String, List<String>>();

	/**
	 * Creates a HttpHeaders object
	 */
	public AsyncHttpHeaders() {}
